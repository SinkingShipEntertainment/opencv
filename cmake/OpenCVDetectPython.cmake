...
if($ENV{REZ_PYTHON_VERSION} EQUAL "2.7.5")
  set(ENV{PYTHON2_EXECUTABLE} $ENV{REZ_PYTHON_ROOT}/bin/python)
  set(ENV{PYTHON2_LIBRARY} $ENV{REZ_PYTHON_ROOT}/lib/python2.7.so)
  set(ENV{PYTHON2_INCLUDE_DIR} $ENV{REZ_PYTHON_ROOT}/include)
...
elseif($ENV{REZ_PYTHON_VERSION} EQUAL "3.7.7")
  set(ENV{PYTHON3_EXECUTABLE} $ENV{REZ_PYTHON_ROOT}/bin/python3)
  set(ENV{PYTHON3_LIBRARY} $ENV{REZ_PYTHON_ROOT}/lib/libpython3.so)
  set(ENV{PYTHON3_INCLUDE_DIR} $ENV{REZ_PYTHON_ROOT}/include)
